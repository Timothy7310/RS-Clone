import { TicketsProfileType } from '../../types/types';

const profileTicketsTemplates = (userInfoWatched: TicketsProfileType): string => `
<div class="profile__tickets">
    <div class="profile__tickets-wrap">
        <h2 class="profile__title">Билеты</h2>
        <p class="profile__count-tick-movies">История билетов(${userInfoWatched.total}):</p>
        ...
        <div class="profile__tickets-list">
            <span class="profile__score-list-warning-text">Вы еще не покупали билеты</span>
        </div>
...
export default profileTicketsTemplates;
